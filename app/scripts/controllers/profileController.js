...
angular.module('Neobazaar')
  .controller('ProfileController', function ($scope, $rootScope, $routeParams, $timeout, $http, $location, UserLoader) {
	  if(!$rootScope.logged) {
	  ...
	  var id = $routeParams && 'id' in $routeParams ? $routeParams.id : 'current';
	  $scope.response = false;
	  $scope.user = new UserLoader({'id': id});
