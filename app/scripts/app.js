...
var app = angular.module('Neobazaar', 
	['Neobazaar.directives', 'Neobazaar.services', 'blueimp.fileupload']);
...
//            },
  ...
  .run(['$rootScope', 'LoggedInLoader', 'CategoriesLoader', 'LocationsLoader', '$timeout', 
	...
	$rootScope.cambio = [
	    ...
	    {value: 'sequenziale', label: 'Sequenziale'},
	...
	$rootScope.cartype = [
	    ...
	    {value: 'fuoristrada', label: 'Fuoristrada/SUV'},
	...
	$rootScope.carbrand = [
	    ...
	    {value: 'bmw', label: 'BMW'},
	    {value: 'bmw-alpina', label: 'BMW-Alpina'},
	    ...
	    {value: 'chetenet', label: 'Chatenet'},
	    {value: 'chery', label: 'Chery'},
	    {value: 'chevrolet', label: 'Chevrolet'},
	    {value: 'china-automobile', label: 'China Automobile'},
	    ...
	    {value: 'deltomaso', label: 'De Tomaso'},
	    {value: 'derways', label: 'Derways'},
	    {value: 'dodge', label: 'Dodge'},
	    {value: 'donkervoort', label: 'Donkervoort'},
	    {value: 'dr-motor', label: 'DR Motor'},
	    {value: 'ferrari', label: 'Ferrari'},
	    {value: 'fiat', label: 'Fiat'},
	    {value: 'ford', label: 'Ford'},
	    {value: 'fun-tech', label: 'Fun Tech'},
	    ...
	    {value: 'merceder-benz', label: 'Mercedes-Benz'},
	    ...
	    {value: 'motos-bikes', label: 'Motos-Bikes'},
	    ...
	    {value: 'tagaz', label: 'TagAZ'},
	    {value: 'talbot', label: 'Talbot'},
	    {value: 'tata', label: 'Tata'},
	    {value: 'teener', label: 'Teener'},
	...
	$rootScope.carcondition = [
	    ...
	    {value: 'epoca', label: 'D\'epoca'},
	    {value: 'demo', label: 'Dimostrativa'},
	    {value: 'azienda', label: 'Aziendale'},
	    {value: 'zero', label: 'Km0'},
	    {value: 'altro', label: 'Altro'}
	];
	$rootScope.motocondition = $rootScope.carcondition
	
	$rootScope.euroclass = [
	    {value: 'euro0', label: 'Pre-Euro'},
	...
	$rootScope.motobrand = [
		...
		{value: 'velosolex', label: 'Velosolex'},
		{value: 'vespa', label: 'Vespa'},
		{value: 'vespino', label: 'Vespino'},
		{value: 'victoria', label: 'Victoria'},
		{value: 'victory', label: 'Victory'},
		{value: 'vor-vertemati', label: 'VOR Vertemati'},
		{value: 'voxan', label: 'Voxan'},
		{value: 'wmi', label: 'WMI'},
		{value: 'xingfu', label: 'Xingfu'},
		{value: 'yamaha', label: 'Yamaha'},
		{value: 'zhongyu', label: 'Zhongyu'},
		{value: 'zingz', label: 'Zing'},
		{value: 'zongshen', label: 'Zongshen'},
		{value: 'zundapp', label: 'Zündapp'},
		{value: 'zweirad-union', label: 'Zweirad Union'},
		{value: 'altro', label: 'Altro'}
	];
	...
	$rootScope.mototype = [
		{value: 'chopper-cruiser', label: 'Chopper/Cruiser'},
		{value: 'ciclomotori', label: 'Ciclomotori'},
		{value: 'cross', label: 'Cross'},
		{value: 'enduro', label: 'Enduro'},
		{value: 'enduro-stradale', label: 'Enduro stradale'},
		{value: 'epoca', label: 'Epoca'},
		{value: 'minimoto', label: 'Minimoto'},
		{value: 'naked', label: 'Naked'},
		{value: 'quad-atv', label: 'Quad/ATV'},
		{value: 'racing', label: 'Racing'},
		{value: 'rally', label: 'Rally'},
		{value: 'scooter', label: 'Scooter'},
		{value: 'sidecar', label: 'Sidecar'},
		{value: 'sport-touring', label: 'Sport touring'},
		{value: 'streetfighter', label: 'Streetfighter'},
		{value: 'super-sportive', label: 'Super sportive'},
	...
	$rootScope.boattype = [
		{value: 'motore', label: 'Barca a motore'},
		{value: 'vela', label: 'Barca a vela'},
		{value: 'gommone', label: 'Gommone'},
		{value: 'acqua', label: 'Moto d\'acqua'},
		{value: 'accessori', label: 'Accessori'},
		{value: 'altro', label: 'Altro'}
	];
	
	$rootScope.campertype = [
		{value: 'camper', label: 'Camper puro'},
		{value: 'caravan', label: 'Caravan/Roulotte'},
		{value: 'mansardato', label: 'Mansardato'},
		{value: 'motorhome', label: 'Motorhome'},
		{value: 'semiintegrale', label: 'Semi-integrale'},
		{value: 'rimorchio', label: 'Rimorchio/altro'},
		{value: 'altro', label: 'Altro'}
	];
	...
	$rootScope.floor = [
		...
		{value: 'terzo', label: 'Terzo'},
		{value: 'quarto', label: 'Quarto'},
		{value: 'quinto', label: 'Quinto'},
		{value: 'sesto', label: 'Sesto'},
		{value: 'settimo', label: 'Settimo'},
		{value: 'soprailsettimo', label: 'Sopra il settimo'},
		{value: 'ultimo', label: 'Ultimo'},
		{value: 'rialzato', label: 'Piano Rialzato'},
		{value: 'multilivello', label: 'Su più livelli'}
	];
	...
	$rootScope.condition = [
		...
		{value: 'ristrutturare', label: 'Da ristrutturare'}
	];
	
	$rootScope.deed = [
		{value: 'occupato', label: 'Occupato'},
		{value: 'libero', label: 'Libero'},
		{value: 'proprieta', label: 'Nuda Proprietà'},
	...
	$rootScope.smoker = [
		{value: 'si', label: 'Consentito'},
		{value: 'no', label: 'Non consentito'}
	];
	
	$rootScope.roomtype = [
		{value: 'singola', label: 'Singola'},
		{value: 'condivisa', label: 'In condivisione'}
	];
	
	$rootScope.rentto = [
		{value: 'uomini', label: 'Uomini'},
		{value: 'donne', label: 'Donne'},
		{value: 'ambosessi', label: 'Ambosessi'}
	];
	
	$rootScope.jobcontracttype = [
		{value: 'agente', label: 'Agente/P.Iva'},
		{value: 'apprendistato', label: 'Apprendistato'},
		{value: 'indeterminato', label: 'Tempo indeterminato'},
		{value: 'progetto', label: 'Contratto a progetto'},
	...
	$rootScope.getCurrentElement = function(data, keyTocheck, valueToCheck) {
	  for(var i in data) {
	...
	$rootScope.categoryMap = new Array();
	...
	$rootScope.categoryMap[35] = 'appartamenti'; // uffici e locali commerciali
